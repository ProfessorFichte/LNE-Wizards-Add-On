	...
	public static class ItemTagGenerator extends RPGSeriesDataGen.ItemTagGenerator {
		...
		protected void configure(RegistryWrapper.WrapperLookup wrapperLookup) {
			...
			getOrCreateTagBuilder(RPGSeriesItemTags.WeaponType.get(Equipment.WeaponType.DAMAGE_STAFF))
					.addOptional(new Identifier("lne_wizards", "elder_guardian_staff_aqua"))
					.addOptional(new Identifier("lne_wizards", "wither_staff_terra"))
					.addOptional(new Identifier("lne_wizards", "ender_dragon_staff_wind"));
		}
	}
}
